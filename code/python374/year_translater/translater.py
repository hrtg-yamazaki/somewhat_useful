class Translater:
    ...
    def jp_era_to_year(self):
        ...
        if era_name[selected_era] == "大正":
            year = 1912 + (jp_year - 1)
            print(era_name[selected_era] + str(jp_year) + "年は、西暦 " + str(year) + " 年です")
        elif era_name[selected_era] == "昭和":
            year = 1926 + (jp_year - 1)
            print(era_name[selected_era] + str(jp_year) + "年は、西暦 " + str(year) + " 年です")
        elif era_name[selected_era] == "平成":
            year = 1989 + (jp_year - 1)
            print(era_name[selected_era] + str(jp_year) + "年は、西暦 " + str(year) + " 年です")
        else:
            year = 2019 + (jp_year - 1)
